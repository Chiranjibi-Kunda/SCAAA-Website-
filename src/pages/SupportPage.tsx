...
export default function SupportPage() {
  return (
    <>
      <PageHero eyebrow="Support Us" title="Help Astronomy Reach More People" copy="Support workflows are prepared for donations and volunteer registration once verified payment/contact details are supplied." image={imagery.classroom} />
