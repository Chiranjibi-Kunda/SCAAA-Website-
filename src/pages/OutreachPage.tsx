...
export default function OutreachPage() {
  return (
    <>
      <PageHero eyebrow="Outreach Programs" title="Astronomy Beyond the City" copy="Samanta Chandra Shekhar Amateur Astronomers' Association (SCAAA) outreach can bring telescope observation, astronomy education and scientific thinking activities to schools, colleges, communities and science festivals." image={imagery.community} />
      ...
      <section className="section form-section">
        <SectionHeader title="Request an Outreach Event" copy="This form is frontend-only for now and ready to connect to Google Forms, Formspree or email later." />
